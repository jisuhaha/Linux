...
<p>mount: device(disk, storage) -&gt; directory mapping<br>
fdisk -l<br>
swap : memory 용도 harddisk 일정공간을 메모리로 사용 (Unix 개발당시 memory가격이 비쌌음)<br>
...
<h3 id="mkfsmakefilesystem">mkfs(makefilesystem)</h3>
<p>mkfs(makefilesystem) 명령어를 통해 디스크 포맷 XFS주로 사용</p>
<blockquote>
