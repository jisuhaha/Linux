...
SSL사설 인증서 생성 
	...
	openssl req -new -key {keyfile} -out {****.csr} -> key 파일을 통해 csr(C)파일 생성 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjM2MjkxMzQsLTEyNTI3NzkxNTMsLTc3OT
IwNjE3OCwxNjc3NjEyMjczLDc2ODgxMzI5NCw4MjA3NzgxMjQs
MzcyMDA1MDA0LDczMDk5ODExNl19
-->