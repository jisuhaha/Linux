...
> # vgs
> 4. vg1를 이용 lv1 - 6G 용량의 논리볼륨을 생성하세요
> # lvcreate -n lv1 -L 6000M vg1
> # lvs
> 5. lv1을 xfs로 파일시스템을 만들고 /data/linux1 디렉토리로 마운트하세요
> # mkfs.xfs /dev/vg1/lv1
> # mkdir -p /data/linux1
> # mount /dev/vg1/lv1 /data/linux1
> # mkdir /data/linux1/{centos,redhat,ubuntu} 
> 
> 6. 기본 논리 볼륨의 크기를 6g -> 9g로 증가시키세요
...
> 7. How to delete PV from Volume Group
> # pvmove /dev/nvme0n2p6
> # vgreduce vg1 /dev/nvme0n2p6
> # pvs
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0Mjk4OTA2MDAsMTc5MTE1MjQ2OSwtMT
