...
영구적용을 하는 경우 --permanent 추가
	...
	- firewall-cmd --get-default-zone : 현재 사용중인 기본 Zone을 확인하는 경우 (/etc/fir


> Written with [StackEdit](https://stackedit.io/).
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzNjYxNzM1OCwxOTg0OTE2NDg3LDI1Mj
IzNTc5NywtOTA5MDcxNzU2LDczMDk5ODExNl19
-->